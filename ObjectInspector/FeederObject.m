    ...
    methods (Hidden = true)
        ...
        function LinkObjects(obj)
            ...
            switch obj.ClassType
                case 'image'
                    obj.ListenerHandle = addlistener(obj.InputObject,'imageOUT','PostSet',@obj.UpdateLink);
                case 'box'
                    obj.ListenerHandle = addlistener(obj.InputObject,'imageOUT_cropped','PostSet',@obj.UpdateLink);
                case 'line'
                    obj.ListenerHandle = addlistener(obj.InputObject,'imageOUT_line','PostSet',@obj.UpdateLink);
                otherwise
