...
* If the MCR is not installed, run MCRInstaller, located in:
  ...
  /tools/matlab/7.9.0/toolbox/compiler/deploy/glnxa64/MCRInstaller.bin
...
================================
-LSF_CustomViewer 
-run_LSF_CustomViewer.sh (shell script run to
     ...
     ii. Set the path by doing one of the following:
        ...
        * Add the MCR directory to the environment variable by issuing 
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_LSF_CustomViewer.sh 
