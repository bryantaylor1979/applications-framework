classdef MultiTextSelectionBox < handle
    ...
    methods (Hidden = true) %COMMON
        function [obj] = MultiTextSelectionBox(varargin)
            ...
            obj.handles.figure = obj.ParentFigureHandle;
            obj.addMultiTextSelectionBox(  obj.paramName );
            obj.EditBoxWidth = obj.EditBoxWidth-1;
            ...
            obj.handle.ParmeterName = obj.paramName;
            obj.handle.Type = 'multi_text_selection';
            obj.handle.ParamName = obj.handles.ParamName;
            obj.handle.EditBox = obj.handles.EditBox;
            obj.handle.SetButton = obj.handles.Button;
        end
